    ...
    <Box
      sx={{
        ...
        "& > :not(style)": {
          ...
          top: 70,
          left: 0,
          padding: props.mobile ? "10px 10px 0px 10px" : "25px 25px 0px 25px",
          maxWidth: props.mobile ? "calc(100% - 20px)" : "calc(100% - 50px)",
    ...
    >
      ...
      >
        ...
        >
          <div
            style={
              props.mobile ? {} : { display: "flex", flexDirection: "row" }
            }
          >
            <div
              style={
              ...
              >
                ...
                <div
                  style={{
                    ...
                    flexDirection: "column",
                    flex: 1,
                    margin: props.mobile ? null : "0px 0px 0px 25px",
                  }}
                >
                  <Box
                    component="section"
