...
import { setActiveUser, setScreenState, setTheme, setUserCookie, setUserFriends, setDarkMode } from './actions/actions';
import './App.css';
...
function App() {
  ...
  return (
    <ThemeProvider theme={MUItheme}>
      ...
      >
        <Fade in={screenState === 'LogIn' || screenState === 'CreateAccount' || (screenState === null && activeUser.firstName == '')}>
